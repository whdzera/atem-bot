...
export async function fetchRandomCard(): Promise<{ info: string; imageUrl?: string }> {
  try {
    ...
    return { info: 'Terjadi kesalahan saat mengambil kartu random. Silakan coba lagi nanti.' };
  }
}
